				...
				<div class="card-block">
					...
					<div class="row m-t-lg">
                      ...
                      <form action="gracias_editar.php" name="form1" method="get">
                          ...
                          <!-- clave -->
								<div class="form-group">
									<label class="form-label" for="nombres">Contraseña del usuario</label>
									<div class="form-control-wrapper">
										<input id="clave" class="form-control" name="clave" type="text" placeholder="Contraseña del usuario" value="<?php echo $clave;?>"    required="">
									</div>
								</div>
