...
swal("ERROR!", "Error al agregar el comunicado.", "error");
	 ...
	 <div class="form-group">
						...
						<div class="col-md-6">
						<h5 class="subtitulo"> Pequeña guia de cómo crear algún comunicado</h5>
							...
							<p class="texto"><li> La descripción suministrada no puede ser la misma a la de otro comunicado.</p></li>
