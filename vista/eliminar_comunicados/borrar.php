...
<?php
  ...
  $data = obtener1Comunicado($_GET['id_comunicado']);
...
?>
  <title>Eliminar Comunicado <?php echo $id_comunicado; ?></title>
</head>
...
?>
  <div class="mobile-menu-left-overlay"></div>
          ...
          <h2><b>¿Está seguro de eliminar el siguiente comumicado del sistema?</b></h2><br>
           
          <div class="form-group row">
						<label class="col-sm-2 form-control-label">Codigo del Comumicado:</label>
							<div class="col-sm-10">
							<p class="form-control-static"><input type="text" class="form-control" value=" <?php echo $id_comunicado; ?>" readonly></p>
						</div>
					</div>
