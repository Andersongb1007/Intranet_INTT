  ...
  <div class="mobile-menu-left-overlay"></div>
         ...
         Titulo:  <?php echo $titulo; ?>
          ...
          <p >
           ...
           Nombre Documento : <?php echo $nombre_documento;?>
             ...
             <input type="hidden" name="ruta_docomento" value="<?php echo $ruta_documento; ?>">
              <input type="hidden" name="titulo" value="<?php echo $titulo; ?>">
                ...
                <div class="form-group centrar">							
                           ...
                           <button class="btn btn-rounded btn-inline btn-danger-outline none"><a  href="../administrar_documentos_privados/index.php" class="none">volver</a></button>
								</div>		
          </form>
    </div> 
