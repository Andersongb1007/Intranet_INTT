...
?>
    <title>Crear Documentos Públicos</title>
</head>
...
?>
	...
	<?php
        ...
        <script type="text/javascript">
		 ...
		 swal({
				title: "ERROR!!",
				text: "Error al agregar el documento, puede que sea demasiado pesado.",
				icon: "error",
				button: "Verificar!",
				});
         </script>
	...
	<div class="page-content">
		...
		<header class="section-header">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h3>Agregar Documentos Públicos</h3>
							<ol class="breadcrumb breadcrumb-simple">
								<li><a href="../home/">Inicio</a></li>
								<li class="active">Agregar Documentos Públicos</li>
							</ol>
						</div>
					</div>
				</div>
			...
			<section class="card">
				<div class="card-block">
					...
					<div class="row m-t-lg">
						<div class="col-md-12">
						<h2 class="titulo2">Agregar Documentos Públicos</h2>
						<h3 class="subtitulo">Complete el formulario</h3>
							...
							<input type="hidden"  name="estado" value="100">
